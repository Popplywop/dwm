...
static const unsigned int bargap    = 36;       /* gap reserved for external bar (polybar) */
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_comma,  tagmonfollow,   {.i = -1 } },
	{ MODKEY|ShiftMask,             XK_period, tagmonfollow,   {.i = +1 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
...
static IPCCommand ipccommands[] = {
  ...
  IPCCOMMAND(  tagmonfollow,        1,      {ARG_TYPE_SINT}   ),
